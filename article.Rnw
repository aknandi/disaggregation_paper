...
becoming increasingly sought after in disease risk mapping~\cite{li2012log, diggle2013spatial}, especially in malaria mapping~\cite{sturrock2014fine, wilson2017pointless}. 
